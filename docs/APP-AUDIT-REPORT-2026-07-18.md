...
| 2 | ProtectedRoute profile race (/coach bounce) | Not started | src/App.tsx, src/store/authStore.ts |
| 3 | Late Slip: per-day dismissal, educator exempt, never on load | Not started | src/components/ui/LateSlipModal.tsx + its trigger |
| 4 | ErrorBoundary at root and route outlet | Not started | new component + src/App.tsx |
| 5 | Route code splitting with React.lazy | Not started | src/App.tsx |
| 6 | Consistency: energy scale, steps goal, clickable progress ring | Not started | src/pages/client/ClientDashboard.tsx, DailyLogPage |
| 7 | Nav consolidation to ~24 items, real lucide icons | Not started, needs approval | src/components/layout/AppLayout.tsx |
| 8 | First-7-days onboarding path | Not started, needs copy sign-off | new, per Section 4 |
