...
const DAYS: DayContent[] = [
  ...
  },
  {
    ...
    supplement: "Your full stack, four products across five doses. Morning with breakfast: Jarrow KSM-66 Ashwagandha 300mg. Afternoon 2 to 3 PM: Swanson Full Spectrum Lemon Balm 500mg. With dinner: the second Ashwagandha 300mg plus Thorne D3/K2 Liquid, 2 drops, which needs the fat in your meal to absorb. Bedtime 9:30 PM: Doctor's Best High Absorption Magnesium 200mg, a 2-tablet serving. That keeps you under the 350mg daily upper limit for supplemental magnesium. IMPORTANT: vitamin K2 works against warfarin and other blood thinners. If you take one, do not start the D3/K2 until your prescriber clears it. These statements have not been evaluated by the Food and Drug Administration. These supplements are not intended to diagnose, treat, cure, or prevent any disease.",
  },
  {
    day: 6,
