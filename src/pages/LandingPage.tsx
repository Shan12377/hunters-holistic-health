...
const TIERS: Tier[] = [
  {
    ...
    features: [
      ...
      '2x monthly 1:1 sessions with Dr. Hunter',
      'Personalized ROOTS protocol walkthrough',
    ...
    cta: 'Apply for VIP',
    ctaStyle: 'secondary',
    scarcity: 'Limited to 10 seats',
  },
  {
    name: 'The Program',
    tagline: 'For accountability-driven learners who want community and live sessions.',
    color: '#c8a74b',
    monthly: '$97',
    annual: '$797',
    ...
    features: [
      ...
      'Unlimited AI Meal Guard',
      'Live monthly group sessions via Dr. Hunter',
      'Direct messaging with Dr. Hunter',
      'Priority classroom content and first access to new releases',
      'Monthly group challenges with recognition',
      'Private cohort room in the community feed',
      'Weekly Pulse AI',
    ],
  ...
  {
    name: 'Foundation',
    tagline: 'The full curriculum and every tool. Self-paced.',
    color: '#91a0ac',
    monthly: '$37',
    annual: '$297',
    ...
    features: [
      'ROOTS curriculum: full access',
      'BP Tracker, Blood Sugar Log, HOMA-IR',
      'Daily Command Center (10-point log)',
      'Supplement Log and Movement Log',
      'AI Meal Guard (5 queries per day)',
      'Weekly Report Card',
      'Community Feed and Leaderboard',
      'Classroom, Challenges, and Events',
    ],
